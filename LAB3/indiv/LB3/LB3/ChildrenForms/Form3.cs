...
namespace LB3.StudName.ChildrenForms
{
    public partial class Form3 : Form
    {
        ...
        private void NumericScanOnValueChanged(object sender, EventArgs e)
        {
            ...
            label2.Text = "Сложение:" + (numericScan1.Value + numericScan2.Value);
            label3.Text = "Вычитание:" + (numericScan1.Value - numericScan2.Value);
        }

        private void numericScan1_Load(object sender, EventArgs e)
        {

        }

        private void numericScan2_Load(object sender, EventArgs e)
        {
